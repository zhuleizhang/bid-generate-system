...
type ExportStep = "select" | "checking" | "review_result" | "exporting" | "done";
...
export default function ExportModal({
  ...
  // 判断是否有警告项
  const hasWarnings =
    reviewResult && reviewResult.warning_count > 0 && !reviewResult.has_blocking_issues;
        ...
        >
          ...
          <Descriptions.Item label="覆盖率">
            <Text
              ...
              style={{
                color:
                  reviewResult.coverage_rate >= 0.8 ? "#52c41a" : "#faad14",
              }}
            >
            ...
            description={
              <List
                ...
                renderItem={(item: ReviewCheckItem) => (
                  <List.Item>
                    <Space>
                      <Tag color={REQUIREMENT_TYPE_LABELS[item.requirement_type] ? "default" : "default"}>
            ...
            description={
              <List
                ...
                renderItem={(item: ReviewCheckItem) => (
                  <List.Item>
                    <Space>
                      <Tag color={REVIEW_STATUS_COLORS[item.status]}>
